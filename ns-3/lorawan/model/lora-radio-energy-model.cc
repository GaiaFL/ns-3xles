...
LoraRadioEnergyModel::GetEnergyPerState()
{
    NS_LOG_FUNCTION(this);
    return energy_state;
}
...
LoraRadioEnergyModel::ChangeState(int newState)
{
    ...
    case EndDeviceLoraPhy::STANDBY:
        ...
        NS_LOG_DEBUG("STANDBY" << " : energy consumption is " << energyToDecrease);
        energy_state["standby"] += energyToDecrease;
        break;
    case EndDeviceLoraPhy::TX:
        energyToDecrease = duration.GetSeconds() * m_txCurrentA * supplyVoltage;
        NS_LOG_DEBUG("TX" << " : energy consumption is " << energyToDecrease);
        energy_state["tx"] += energyToDecrease;
        break;
    case EndDeviceLoraPhy::RX:
        energyToDecrease = duration.GetSeconds() * m_rxCurrentA * supplyVoltage;
        NS_LOG_DEBUG("RX" << " : energy consumption is " << energyToDecrease);
        energy_state["rx"] += energyToDecrease;
        break;
    case EndDeviceLoraPhy::SLEEP:
        energyToDecrease = duration.GetSeconds() * m_sleepCurrentA * supplyVoltage;
        NS_LOG_DEBUG("SLEEP" << " : energy consumption is " << energyToDecrease);
        energy_state["sleep"] += energyToDecrease;
        break;
    default:
